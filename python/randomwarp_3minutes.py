...
def main():
    ...
    print("also, there is a datapack that goes along with this that goes in your server's world's datapack folder, it will work regardless of if you install it or not!")
    print("and remember to not minimize this application or the command prompt... Also, the time between each teleport is 3 minutes! Have fun!")
    print("---------- ")
    print(" ")
    sleep(1.3)
    ...
    sleep(2.5)
    print("Prepare, you will be teleported in 3 minutes.")
